...
- [kubernetes-sigs/custom-metrics-apiserver](https://github.com/kubernetes-sigs/custom-metrics-apiserver) ([v1.34.0](https://github.com/kubernetes-sigs/custom-metrics-apiserver/releases/tag/v1.34.0), 1 day ago) - Framework for implementing custom metrics support for Kubernetes
