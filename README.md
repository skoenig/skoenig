...
- [KusionStack/kusion](https://github.com/KusionStack/kusion) ([v0.13.0-alpha.3](https://github.com/KusionStack/kusion/releases/tag/v0.13.0-alpha.3), 3 days ago) - Declarative Intent Driven Platform Orchestrator for Internal Developer Platform (IDP).
...
- [sodadata/soda-core](https://github.com/sodadata/soda-core) - :zap: Data quality testing for the modern data stack (SQL, Spark, and Pandas) https://www.soda.io (2 weeks ago)
