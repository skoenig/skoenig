...
- [KusionStack/kusion](https://github.com/KusionStack/kusion) ([v0.14.0-rc.1](https://github.com/KusionStack/kusion/releases/tag/v0.14.0-rc.1), 1 day ago) - Declarative Intent Driven Platform Orchestrator for Internal Developer Platform (IDP).
- [kubernetes/minikube](https://github.com/kubernetes/minikube) ([v1.35.0](https://github.com/kubernetes/minikube/releases/tag/v1.35.0), 1 day ago) - Run Kubernetes locally
- [ionos-cloud/terraform-provider-ionoscloud](https://github.com/ionos-cloud/terraform-provider-ionoscloud) ([v6.6.9](https://github.com/ionos-cloud/terraform-provider-ionoscloud/releases/tag/v6.6.9), 3 days ago) - The IonosCloud Terraform provider gives the ability to deploy and configure resources using the IonosCloud APIs.
