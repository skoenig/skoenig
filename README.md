...
- [KusionStack/kusion](https://github.com/KusionStack/kusion) ([v0.12.0-rc.1](https://github.com/KusionStack/kusion/releases/tag/v0.12.0-rc.1), 1 week ago) - Declarative Intent Driven Platform Orchestrator for Internal Developer Platform (IDP).
- [kubernetes/minikube](https://github.com/kubernetes/minikube) ([v1.33.1](https://github.com/kubernetes/minikube/releases/tag/v1.33.1), 4 weeks ago) - Run Kubernetes locally
...
- [cloud-ark/kubeplus](https://github.com/cloud-ark/kubeplus) - Kubernetes Operator to create Kubernetes-native APIs from Helm charts for multi-instance SaaS (1 month ago)
- [InternalDeveloperPlatform/public-site](https://github.com/InternalDeveloperPlatform/public-site) -  (2 months ago)
- [shospodarets/awesome-platform-engineering](https://github.com/shospodarets/awesome-platform-engineering) - Curated list of tools and resources for Platform Engineering (2 months ago)
