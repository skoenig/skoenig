...
- [skoenig/cookhack](https://github.com/skoenig/cookhack) - personal collection of tasty recipes (instructions in German) (today)
...
- [Add under-utilized HPA alert](https://github.com/samber/awesome-prometheus-alerts/pull/330) on [samber/awesome-prometheus-alerts](https://github.com/samber/awesome-prometheus-alerts) (6 days ago)
...
- [hhursev/recipe-scrapers](https://github.com/hhursev/recipe-scrapers) ([14.26.0](https://github.com/hhursev/recipe-scrapers/releases/tag/14.26.0), 1 month ago) - Python package for scraping recipes data
