...
- [hhursev/recipe-scrapers](https://github.com/hhursev/recipe-scrapers) ([14.21.0](https://github.com/hhursev/recipe-scrapers/releases/tag/14.21.0), 5 days ago) - Python package for scraping recipes data
...
- [jsonresume/resume-schema](https://github.com/jsonresume/resume-schema) - JSON-Schema is used here to define and validate our proposed resume json (3 weeks ago)
...
- [LukeSmithxyz/based.cooking](https://github.com/LukeSmithxyz/based.cooking) - A simple culinary website. (3 weeks ago)
