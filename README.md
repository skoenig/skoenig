...
- [ionos-cloud/terraform-provider-ionoscloud](https://github.com/ionos-cloud/terraform-provider-ionoscloud) ([v6.5.5](https://github.com/ionos-cloud/terraform-provider-ionoscloud/releases/tag/v6.5.5), 6 days ago) - The IonosCloud Terraform provider gives the ability to deploy and configure resources using the IonosCloud APIs.
- [kubernetes/minikube](https://github.com/kubernetes/minikube) ([v1.34.0](https://github.com/kubernetes/minikube/releases/tag/v1.34.0), 2 weeks ago) - Run Kubernetes locally
- [KusionStack/kusion](https://github.com/KusionStack/kusion) ([v0.13.0-alpha.2](https://github.com/KusionStack/kusion/releases/tag/v0.13.0-alpha.2), 3 weeks ago) - Declarative Intent Driven Platform Orchestrator for Internal Developer Platform (IDP).
